...
//' @description This function performs the Alternating Direction Method of Multipliers (ADMM) on a matrix of predictors and a vector of responses.
...
//' @name cg_admm_alpha
//' @title Alternating Direction Method of Multipliers with Elastic Net Regularization
//' @description This function performs the Alternating Direction Method of Multipliers (ADMM) with Elastic Net Regularization on a matrix of predictors and a vector of responses
//' @param X A matrix of predictors of dimension n x p.
//' @param b A vector of responses of length p.
//' @param lambda A numeric value for regularization.
